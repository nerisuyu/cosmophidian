...
function draw_menu()
	...
	pal(10,2)
	spr(208,10,55,-2+tt/2,3)
	pal(10,play_btn_color)
	spr(208,10,54,-2+tt/2,3)
	print("press ❎ to play",30,91,2)
...
function handle_input()
	...
	if btn(🅾️) then
		...
		if ship.states.parry_cd <0 and (ship.laser_charge>ship.dash_cost or (ship.laser_charge>0 and ship.laser_charge-ship.dash_cost<=0))then
			...
			local ca,sa=trig(ship.angle)
			local qq=ship.x
			local ww=ship.y
			add_object({group=list_projectiles,
				hp=10,
					draw=function ()
					line(qq,ww,qq+20*ca,ww+20*sa,12)
...
function bh_snake_towards_ship(self)
	bh_face_towards_ship(self)
	self.angle1=self.angle+self.isturning*sin(self.seed/100+tt/150)/10
	bh_fly_straight(self)
end

function bh_update_pellet(self)
	add_enemy_projectile_collider(self)
	if  band(stat(34),0x1)~=1 and not btn(❎) then
...
function drw_boss(self)
	...
	print("the pale queen",cam.x-26,cam.y-63,7)
end
...
function boss_laser(self)
	add_animation(function ()
		...
		self.isturning=0.5
		self.turning_d=0.005
		self.speed=0.1
		add_object({
				group=list_projectiles,
				hp=40,
				draw=function ()
					draw_laser(self.x,self.y,self.angle1,150)
				end}
				,template_basic_particle) 
		for i=0,40 do 
			yield()
			fire_laser(self.x,self.y,self.angle1,150,15,false)
		end
		self.speed=1
...
function boss_wander(self)
	add_animation(function ()
		...
		if(get_distance(self,ship)>=65) then 
	...
	on_death={fx_explode,od_die_snake,od_drop_pellets,
		function() 
			...
			add_object({
				...
				hp=600,
				draw=function (self)
					local ass="thank you for playing♥"
					if self.hp>300 then
						ass="the queen is dead"
					end

					print(ass,cam.x-45,cam.y-20,7)
				end,
...
stage6={
	name="stage 6",
	cards={{template_enemy_shooter,25,2},{template_enemy_fish,5,1},{template_snake,15,3}},
	max_enemies=15,
	volume=50,
	goal=50
}
...
stage5={
	name="stage 5",
	cards={{template_enemy_shooter,40,4},{template_enemy,5,2}},
	max_enemies=5,
	volume=50,
	goal=30,
	next=stage6
...
stage4={
	name="stage 4",
	cards={{template_enemy_shooter,15,4}},
	max_enemies=6,
	volume=50,
	goal=20,
	next=stage5,
...

...

...
__label__

