...
var shrinko_path="shrinko8\\shrinko8.py"

var build_header = "pico-8 cartridge // http://www.pico-8.com\nversion 8\n__lua__\n"

gulp.task("convert-to-PNG",function(cb){
    exec('python '+ shrinko_path+' '+ build_path+'\\'+CART_NAME+'.p8'+' '+build_path+'\\'+CART_NAME+'.p8.png', function (err, stdout, stderr) {
        console.log(stdout);
        console.log(stderr);
        cb(err);
      });
